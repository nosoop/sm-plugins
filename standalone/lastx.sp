/**
* lastx.sp by HomicidalApe, nosoop
...
public OnPluginStart()
{
	...
	HookEvent("player_disconnect", Hook_PlayerDisconnectPre, EventHookMode_Pre);
}

public Hook_PlayerDisconnectPre(Handle:event, const String:name[], bool:dontBroadcast) {
    if (!GetEventBool(event, "bot")) {
        decl String:steamname[64], String:steamid[32];
        ...
        SetArrayString(PlayerName, 0, steamname);
        SetArrayString(PlayerAuthid, 0, steamid);
    }
}
